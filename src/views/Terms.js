...
const TermsOfUse = () => {
  return (
    <Container className="py-5 mb-5">
      <Row>
        <Col>
          <h1 className="mb-4">Terms of Use for Meksova</h1>
          <p className="lead">
            <strong>Effective Date: 01/01/2025</strong>
          </p>
          <p>
            Welcome to Meksova, an online service platform designed to
          ...
          <p>
            By accessing or using the Meksova platform, you acknowledge
          ...
          <p>
            ...
            you input into the Meksova system. This includes but is not
            limited to recording transactions, managing receipts, and providing
            correct financial information. Meksova is not responsible
          ...
          <p>Meksova provides users with the following features:</p>
          <ul>
            <li>
          ...
          <p>
            Meksova makes no representations or warranties regarding the
          ...
          <p>
            By using the Service, you acknowledge and agree that Meksova
            ...
            are solely your responsibility, and that Meksova is not
          ...
          <p>
            Meksova takes the security of your data seriously and will
          ...
          <p>
            Meksova reserves the right to suspend or terminate your
          ...
          <p>
            Meksova provides the Service &quot;as is&quot; and without
          ...
          <p>
            You agree to indemnify, defend, and hold harmless Meksova
