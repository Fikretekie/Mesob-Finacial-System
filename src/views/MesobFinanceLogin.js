            ...
            <form onSubmit={handleSignup}>
              ...
              <div className="explanation-box">
                <p>
                  ...
                  money owed to you, any debt you owe, and any valuable items
                  (like inventory) you own. This helps us build an accurate
                  financial picture of your business (recommended).
                </p>
                <button
                  type="button"
                  className="start-from-zero"
