...
//     // If no status field, we can't determine it
//     return 'Unknown';
//   };
...
//     {
//       name: "Provider",
//       selector: (row) => detectProvider(row.subscription) || "-",
//       sortable: true,
//       width: "120px",
//       cell: (row) => {
//         const provider = detectProvider(row.subscription);
...
//     {
//       name: "Status",
//       selector: (row) => detectStatus(row.subscription) || "-",
//       sortable: true,
//       width: "120px",
//       cell: (row) => {
//         const status = detectStatus(row.subscription);
...
//           console.log('User has subscriptionId but no subscription object found:', {
//             userId: user.id,
//             email: user.email,
//             subscriptionId: user.subscriptionId,
//             availableSubIds: subscriptionsData.map(s => s.userId)
//           });
//         }
...
//         (user) => {
//           console.log('=>>>>>', user);
//           detectProvider(user.subscription)?.toLowerCase() === providerFilter.toLowerCase()
//         }
//       );
//     }
...
//     const stripeCount = activeSubscriptions.filter(
//       (user) => detectProvider(user.subscription)?.toLowerCase() === "stripe"
//     ).length;

//     const paypalCount = activeSubscriptions.filter(
//       (user) => detectProvider(user.subscription)?.toLowerCase() === "paypal"
//     ).length;
