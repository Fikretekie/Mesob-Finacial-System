        ...
        try {
            ...
            await updateUserAttributes({
                userAttributes: {
                    ...
                    'custom:businessType': businessType === "Other" ? otherBusinessType : businessType,
                }
            });

            // Update your database
            const businessTypeValue = businessType === "Other" ? otherBusinessType : businessType;
            const response = await axios.put(
                `https://dzo3qtw4dj.execute-api.us-east-1.amazonaws.com/dev/MesobFinancialSystem/Users/${localStorage.getItem("userId")}`,
                {
                    name,
                    companyName,
                    phone_number: phone,
            ...
            showNotification("danger", "Failed to complete profile. Please try again.");
        }
    };
    ...
    return (
        <div className="complete-profile-container">
            ...
            <div className="complete-profile-box">
                ...
                <p>Please provide some additional information to finish setting up your account</p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="input-group">
                        ...
                        >
                            ...
                            <option value="RIDESHARE DRIVERS/PARTNERS">RIDESHARE DRIVERS/PARTNERS</option>
                            <option value="Groceries">Groceries</option>
                            <option value="Individual/Households">Individual/Households</option>
                    ...
                    {businessType === "Other" && (
                        <div className="input-group">
                            ...
                            {errors.otherBusinessType && (
                                <span className="error-message">{errors.otherBusinessType}</span>
                            )}
                        </div>
                    )}
